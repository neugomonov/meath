...
public class MenuController implements Initializable {
    ...
    public void deleteItem(ActionEvent event) {
        ...
        try {
            ...
            infoBox1("Пожалуйста, выберите заказ", null, "Error");
        }
    ...
    //code below is loading the payment screen
    @FXML
    public void PaymentScreen(ActionEvent event) throws Exception {
        Stage primaryStage = new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("PaymentFancy.fxml"));
        ...
        try {
            ...
            if (!(oldpass.isEmpty() || newpass.isEmpty())) {
                if (menuModel.check_if_pass_equal_to_old(oldpasstxt.getText())) {
                    ...
                    infoBox1("Пожалуйста, введите свой старый пароль правильно", null, "failed to change password");
                }
            } else {
                infoBox1("Пожалуйста, введите пароль", null, "Alert!");
            }
        ...
        if (!(statetxt.getText().isEmpty() || citytxt.getText().isEmpty() || landtxt.getText().isEmpty() || pincodetxt.getText().isEmpty())) {
            ...
            if (type) {
                ...
                try {
                    ...
                    pincodetxt.clear();
                    getAddress();
                    infoBox1("Адрес успешно изменён", null, "success");
                } catch (SQLException ex) {
                    Logger.getLogger(MenuController.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                infoBox1("Обновление отменено", null, "cancelled");
                statetxt.clear();
                citytxt.clear();
                landtxt.clear();
                pincodetxt.clear();
            ...
            infoBox1("Пожалйста, заполните пустые поля адреса", null, "Update failed");
        }
    }
        ...
        if (menuModel.isItemInCart()) {
            ...
            if (type) {
                ...
                try {
                    ...
                    dialogStage.close();
                    Scene scene;
                    scene = new Scene(FXMLLoader.load(getClass().getResource("PaymentFancy.fxml")));
