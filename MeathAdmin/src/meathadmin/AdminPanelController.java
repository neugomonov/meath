...
public class AdminPanelController implements Initializable {
    ...
    public void AddEmployee(ActionEvent event) {
        ...
        try {
            ...
            infoBox("Пожалуйста, заполните пустые поля", null, "Alert");
    ...
    public void TakeOrderScreen(ActionEvent event) throws Exception {
        ...
        primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("meath-admin.png")));
        primaryStage.setTitle("МЯСА — Админ");
